            ...
            AspectRatio(
              ...
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => const ColoredBox(
                  color: AppColors.surfaceVariant,
                  child: Icon(Symbols.broken_image, color: AppColors.secondary, size: 40),
                ),
              ),
            ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Symbols.favorite, size: 20, color: AppColors.secondary.withValues(alpha: 0.7)),
                    ...
                    Icon(Symbols.chat_bubble, size: 20, color: AppColors.secondary.withValues(alpha: 0.7)),
                    const SizedBox(width: 6),
                    Text(
                      '12',
                      style: theme.textTheme.labelMedium?.copyWith(
                    ...
                    const Spacer(),
                    Icon(Symbols.share, size: 20, color: AppColors.secondary.withValues(alpha: 0.7)),
                  ],
                ),
              ],
            ),
